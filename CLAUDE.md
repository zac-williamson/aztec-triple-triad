...
Interactive development — working with Zac to solve architectural issues and bugs.

**Aztec version**: v4.2.0-nightly.20260323
...
- **ALL** Aztec dependencies MUST be version `4.2.0-nightly.20260323`
...
- Use version v4.2.0-nightly.20260323 specifically
...
### Aztec SDK Import Paths (for v4.2.0-nightly.20260323)
```typescript
...
### Aztec SDK Packages (use versions matching v4.2.0-nightly.20260323)
```
