...
- Aztec version: v4.2.0-nightly.20260320
...
- **ALL** Aztec dependencies MUST be version `4.2.0-nightly.20260320`
...
- Use version v4.2.0-nightly.20260320 specifically
...
### Aztec SDK Import Paths (for v4.2.0-nightly.20260320)
```typescript
...
### Aztec SDK Packages (use versions matching v4.2.0-nightly.20260320)
```
