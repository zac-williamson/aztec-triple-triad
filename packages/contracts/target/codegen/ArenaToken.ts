...
export class ArenaTokenContract extends ContractBase {
  ...
  public static deploy(wallet: Wallet, admin: AztecAddressLike) {
    return new DeployMethod<ArenaTokenContract>(PublicKeys.default(), wallet, ArenaTokenContractArtifact, (instance, wallet) => ArenaTokenContract.at(instance.address, wallet), Array.from(arguments).slice(1));
  }
  ...
  public static deployWithPublicKeys(publicKeys: PublicKeys, wallet: Wallet, admin: AztecAddressLike) {
    return new DeployMethod<ArenaTokenContract>(publicKeys, wallet, ArenaTokenContractArtifact, (instance, wallet) => ArenaTokenContract.at(instance.address, wallet), Array.from(arguments).slice(2));
  }
  ...
  public static deployWithOpts<M extends keyof ArenaTokenContract['methods']>(
    ...
    return new DeployMethod<ArenaTokenContract>(
      opts.publicKeys ?? PublicKeys.default(),
      opts.wallet,
      ArenaTokenContractArtifact,
      (instance, wallet) => ArenaTokenContract.at(instance.address, wallet),
