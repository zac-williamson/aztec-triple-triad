...
cooldown_notes: {
  ...
  public declare methods: {
    ...
    /** test_nullify_10_cards(owner: struct, token_ids: array) */
    test_nullify_10_cards: ((owner: AztecAddressLike, token_ids: FieldLike[]) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
